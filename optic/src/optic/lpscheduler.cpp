...
protected:
    ...
    void addNormalEffect(RPGBuilder::RPGNumericEffect* const ceItr) const {
    ...
    void addOrderIndependentMetricEffect(RPGBuilder::RPGNumericEffect* const ceItr) const {
...
public:
    ...
    void operator()(RPGBuilder::RPGNumericEffect* const ceItr) const {
